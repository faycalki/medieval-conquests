...
#Patched to an extent status ammo ready below added a Tuple.
	("status_ammo_ready", 0, "status_ammo_ready", 0, 0, 0, 0, 0, 0, 1, 1, 1),
#Start main menu dust effect
...
#  ("main_menu_background", 0, "main_menu_nord", 0, 0, 0, 0, 0, 0, 1, 1, 1), #Not needed
