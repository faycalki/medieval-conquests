...
scene_props = [
	...
	("catapult_destructible", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "Catapult", "bo_Catapult", 
	[(ti_on_scene_prop_init,
		[
			(store_trigger_param_1, ":trigger_param_1"),
	...
	("door_destructible", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable|spr_use_time(2), "tutorial_door_a", "bo_tutorial_door_a", 
	...
	("dummy_a", sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "arena_archery_target_b", "bo_arena_archery_target_b", 
	[(ti_on_scene_prop_destroy,
		[
			(store_trigger_param_1, ":trigger_param_1"),
	...
	("castle_f_door_a", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "castle_f_door_a", "bo_castle_f_door_a", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("castle_f_sally_door_a", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "castle_f_sally_door_a", "bo_castle_f_sally_door_a", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("castle_e_sally_door_a", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "castle_e_sally_door_a", "bo_castle_e_sally_door_a", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("belfry_a", sokf_moveable, "belfry_a", "bo_belfry_a", [
		...
		(eq, "$belfry_sound_coop", 0),
		(store_trigger_param_1, ":trigger_param_1"), #Prop_instance_ID.
		
    (prop_instance_stop_sound, ":trigger_param_1"), #sf_looping|sf_priority_15|sf_vol_7
	(prop_instance_play_sound, ":trigger_param_1", "snd_belfry_sound"), #sf_looping|sf_priority_15|sf_vol_7
	(assign, "$belfry_sound_coop", 1),
		]),
		...
		(neg|multiplayer_is_dedicated_server),
		(store_trigger_param_1, ":trigger_param_1"), #Prop_instance_ID.
		#(display_message, "@Stopping prop."),
		(prop_instance_stop_sound, ":trigger_param_1"), #sf_looping|sf_priority_15|sf_vol_7
		(prop_instance_play_sound, ":trigger_param_1", "snd_belfry_sound_end"), #sf_looping|sf_priority_15|sf_vol_7
		(assign, "$belfry_sound_coop", 0),
		])
]),
...
#
#			(neg|multiplayer_is_dedicated_server),
#			(store_trigger_param_1, ":prop_instance"),
#			(store_mission_timer_a_msec, ":time_msec"),
#			#if next action time is lower than current time, play the sound
#			(neg|scene_prop_slot_ge, ":prop_instance", scene_prop_next_action_time, ":time_msec"),
#			(display_message, "@Stopping 543"),
#			#(prop_instance_stop_sound, ":prop_instance"),
#			(prop_instance_play_sound, ":prop_instance", "snd_belfry_sound", 0),
#
#			#calculate next action time by adding the sound-play-length in msec to the current time
#			(val_add, ":time_msec", 10000),#assuming your sound plays for 3 sec
#			(scene_prop_set_slot, ":prop_instance", scene_prop_next_action_time, ":time_msec"),
#		]),
#
#		(ti_on_scene_prop_animation_finished,
#		[
#		(game_in_multiplayer_mode),
#		(neg|multiplayer_is_dedicated_server),
#		(store_trigger_param_1, ":prop_instance"), #Prop_instance_ID.
#
#		(eq, "$belfry_positioned", 3),
#		#(prop_instance_stop_sound, ":prop_instance"), #sf_looping|sf_priority_15|sf_vol_7
#		(prop_instance_play_sound, ":prop_instance", "snd_belfry_sound_end"), #sf_looping|sf_priority_15|sf_vol_7
#		#(assign, "$belfry_sound_coop", 0),
#		])
#]),
#
...
#	(prop_instance_play_sound, ":belfry_scene_prop_id", "snd_belfry_sound"), #sf_looping|sf_priority_15|sf_vol_7
#	(assign, "$belfry_sound_coop", 1),
#		
#		
#			#
...
#		
#		(assign, "$belfry_sound_coop", 0),
#		(display_message, "@Prop stopped moving."),
#			(try_for_range, ":belfry_kind", 0, 2),
#      (try_begin),
#        (eq, ":belfry_kind", 0),
#        (assign, ":belfry_body_scene_prop", "spr_belfry_a"),
...
#      (try_for_range, ":belfry_no", 0, ":num_belfries"),
#        (scene_prop_get_instance, ":belfry_scene_prop_id", ":belfry_body_scene_prop", ":belfry_no"),
#		(prop_instance_stop_sound, ":belfry_scene_prop_id"), #sf_looping|sf_priority_15|sf_vol_7
#			#(store_trigger_param_1, ":trigger_param_1"),
#		])
#	]),
	...
	("trebuchet_destructible", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "trebuchet_new", "bo_trebuchet_old", 
	[(ti_on_scene_prop_init,
		[
			(store_trigger_param_1, ":trigger_param_1"),
	...
	("portcullis", sokf_moveable|sokf_weapon_knock_back_collision, "portcullis_a", "bo_portcullis_a", []),
	...
	("gourd", sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable|sokf_enforce_shadows|spr_hit_points(1), "gourd", "bo_gourd", 
	[(ti_on_scene_prop_destroy,
		[
			(store_trigger_param_1, ":trigger_param_1"),
	...
	("dummy_a_undestructable", sokf_destructible|sokf_weapon_knock_back_collision, "arena_archery_target_b", "bo_arena_archery_target_b", 
	[(ti_on_scene_prop_init,
		[
			(store_trigger_param_1, ":trigger_param_1"),
	...
	("earth_sally_gate_left", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "earth_sally_gate_left", "bo_earth_sally_gate_left", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("earth_sally_gate_right", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "earth_sally_gate_right", "bo_earth_sally_gate_right", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("viking_keep_destroy_sally_door_right", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "viking_keep_destroy_sally_door_right", "bo_viking_keep_destroy_sally_door_right", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("viking_keep_destroy_sally_door_left", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "viking_keep_destroy_sally_door_left", "bo_viking_keep_destroy_sally_door_left", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("castle_f_door_b", sokf_show_hit_point_bar|sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "castle_e_sally_door_a", "bo_castle_e_sally_door_a", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	###Inventory access patched to an extent
	#COOP BEGIN############################################################################
...
#COOP END#########################################################################################
	...
	("1257_earth_gate", sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "earth_sally_gate_left", "bo_earth_sally_gate_left", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("1257_portcullis", sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "1257_portcullis_a", "bo_1257_portcullis_a", 
	[(ti_on_scene_prop_init,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(scene_prop_set_hit_points, ":trigger_param_1", 3000)
	...
	("1257_tavern_door_a", sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "1257_tavern_door_a", "bo_1257_tavern_door_a", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("1257_tavern_door_b", sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "1257_tavern_door_b", "bo_1257_tavern_door_b", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
	...
	("1257_castle_f_door_a", sokf_destructible|sokf_weapon_knock_back_collision|sokf_moveable, "1257_castle_f_door_a", "bo_1257_castle_f_door_a", 
	[(ti_on_scene_prop_use,
		[
			(store_trigger_param_1, ":trigger_param_1"),
			(store_trigger_param_2, ":trigger_param_2"),
