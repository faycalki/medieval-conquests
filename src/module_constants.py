...
##############################################################
### recruiter kit begin troop recruiter #####Begin add diplomacy comment out the below since you'll use a diplomatic version of recruiter kite.
...
#Add Crouching
slot_agent_crouching = 29
#End add AI crouching MCV0.999H
...
#####Begin add diplomacy uncomment out the slot_faction_num_parties!
##diplomacy start+
slot_faction_number_of_parties    = 20#Deprecated, use slot_faction_num_parties instead
#slot_faction_num_parties          = slot_faction_number_of_parties #UNCOMMENT ME IF ADDING DIPLOMACY
##diplomacy end+
#####End add diplomacy
...
#####Begin add diplomacy uncomment out the lines below
...
### Insert in the party slots section.

################################################################################
# LAV MODIFICATIONS START (EMOTICON MOD)
################################################################################

#slot_party_emoticon               = 499 # Or pick another unused slot
...
#####Begin add Diplomacy uncomment below lines
...
#SLOT FOR TROOP UPGRADING OSP
slot_root_troop = 23
#https://forums.taleworlds.com/index.php/topic,64393.0.html
#END SLOT FOR TROOP UPGRADING OSP (SLIDER) 
...
#####Begin add diplomacy uncomment the lines below
...
#####Begin add diplomacy make sure to comment out the old loagent_war_declaration_types_end because the new value is higher!
##diplomacy begin
#logent_faction_declares_war_to_fulfil_pact	    = 95
#logent_war_declaration_types_end							= 96
##diplomacy end
#####Comment out this line below if adding diplomacy
...
#####Kaos begin add factions begin (change to trp_kingdom_1_pretender after adding kingdom 1 pretender)
pretenders_begin = "trp_kingdom_1_pretender" 
pretenders_end = "trp_knight_1_1"

rebel_factions_begin = "fac_kingdom_43"
rebel_factions_end =   "fac_kingdoms_end" # If you wish to have empires *Civil factions below*, this value should be set to max rebels than max civils. "fac_kingdom_84"

civil_factions_begin = "fac_kingdom_43" #same as rebels
...
multiplayer_scenes_begin = "scn_scene_sea"
#multiplayer_scenes_end = "scn_1257_combat_mountain_6"
multiplayer_scenes_end = "scn_manor" #WAS THIS In V1.000
#multiplayer_scenes_begin = "scn_multi_scene_1"
#multiplayer_scenes_end = "scn_town_house_eastern"
#
#
#
#multiplayer_scene_names_begin = "str_multi_scene_1" V1.000
#multiplayer_scene_names_end = "str_multi_scene_end" V1.000

multiplayer_scene_names_begin = "str_scene_sea"
...
#envfix begin random events, may have to choose correct towns and villages end portion, or else the scripts for those may not execute at all, I have not bothered looking but i think it'll be fine*.
...
#scenes_begin = "scn_town_arab_center" #v0.999C
#scenes_end = "scn_town_arab_castle" #V0.999C
#below is V0.999E
scenes_begin = "scn_town_1_room"
scenes_end = "scn_town_house_eastern"
#Above is V0.999E
#scenes_end = "scn_castle_1_exterior" #Default patched to an extent
...
#Envfix begin events items, may have to choose correct items from source or else only smoked fish will be acquired.
...
banner_meshes_end_minus_one = "mesh_arms_a01"

arms_meshes_begin = "mesh_arms_a01"
arms_meshes_end_minus_one = "mesh_troop_label_banner"
...
custom_banner_flag_scene_props_begin = "spr_banner_a01"
custom_banner_flag_scene_props_end = "spr_banner_kingdom_30"
...
banner_scene_props_end_minus_one = "spr_banner_kingdom_30"
...
keys_list = [("$key_crouch",          key_z, "Player Crouching/Standing"),
...
#####Kaos safe begin useless
#DPLMC_VIRTUAL_RELATIVE_MULTIPLIER = 696
#DPLMC_VIRTUAL_RELATIVE_FATHER_OFFSET = 697
#DPLMC_VIRTUAL_RELATIVE_MOTHER_OFFSET = 698
######Kaos safe end

#####Begin add diplomacy
##diplomacy begin
# recruiter kit begin DIPLOMACY RECRUITER BEGIN
...
##diplomacy end+ DIPLOMACY RECRUITER END
...
#Independent action time
#music_timer = 666

#Co-op events for SP players BEGIN
version_number = 1
build_number = 3333333333
#Co-op events for SP players END